#Jake Decoto Note:  Below is a modified version of the Balle algorithm described in paper referenced below.
#Modification includes adding an 'importance map' CNN that allows for learned variable bit rate to be used across the image
#Initial results (2/22/2019) show improved performance in terms of MS-SSIM versus the baseline Balle algorithm
#although a lot more testing would be needed to confidently make that claim
