#Jake Decoto Note:  Below is a heavily modified version of the Balle algorithm described in paper referenced below.
#Modification include adding an 'importance map' CNN that allows for learned variable bit rate to be used across the image
