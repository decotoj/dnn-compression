...
LMBDA = 0.1  # Lambda Parameter Controlling Rate vs Distortion Loss Function Weighting
LEARNING_RATE = 1e-4 #Nominally 1e-3

#Constants (Including Hyperparameters Treated as Constants)s
MODEL_DIRECTORY = 'model/balle_001_quality'  # Relative location where model files will be saved
