...
LMBDA = 1#0.01  #Relative Importance of Distortion vs Rate Loss (Higher Value Weights Distortion Loss More Heavily)
LEARNING_RATE = 1e-5 #Nominally 1e-4
...
MODEL_DIRECTORY = 'model/li_003'  # Relative location where model files will be saved
