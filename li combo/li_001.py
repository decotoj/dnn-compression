...
LMBDA = 1#0.01 #0.01 #Relative Importance of Distortion vs Rate Loss (Higher Value Weights Distortion Loss More Heavily)
...
MODEL_DIRECTORY = 'model/li_001_base'  # Relative location where model files will be saved
...
def train():
  ...
  # #Log Input Settings
  logFile = MODEL_DIRECTORY + '/' + str(round(time.time(),0)) + '_train_log.txt'
  ...
  train_loss = LMBDA * train_mse + rateLoss
