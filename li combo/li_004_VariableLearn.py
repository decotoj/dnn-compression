...
MODEL_DIRECTORY = 'model/li_004_VariableLearn'  # Relative location where model files will be saved
...
if __name__ == "__main__":
    ...
    NUM_STEPS = 75100  # Maximum number of steps to train (NOTE: 1,000,000 used by Balle)

    train()

    print('ROUND TWO')

    LEARNING_RATE = 1e-5  # Nominally 1e-5
